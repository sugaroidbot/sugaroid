...
-  ``sugaroid.trainer.json`` : Is a JavaScript Object Notation file
   ...
   or ``stable``
-  ``sugaroid_internal.db``: A training dataset which learns from user
   input and accordingly saves them with low confidence. This data is
   later used to train sugaroid in future according to probability
   datasets
