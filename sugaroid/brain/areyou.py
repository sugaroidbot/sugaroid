...
class AreYouAdapter(SugaroidLogicAdapter):
    ...
    def process(self, statement: SugaroidStatement, additional_response_selection_parameters=None):
        ...
        if "bot" in statement.lemma or "machine" in statement.lemma or "computer" in statement.lemma:
            ...
            confidence = 0.75
        elif "human" in statement.lemma or "man" in statement.lemma or "woman" in statement.lemma or "sapien" in statement.lemma:
            ...
            response = "I am written in python. Specifically, on v%s" % sys.version.replace("\n", " ")
            confidence = 1
        elif "newborn" in statement.lemma or "infant" in statement.lemma or "child" in statement.lemma:
            response = "I am a newbie bots. I am trying to learn from my uncle and aunty bots and learning from them."
        elif "dumb" in statement.lemma or "foolish" in statement.lemma or "mad" in statement.lemma or \
