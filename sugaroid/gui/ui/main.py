...
"}")
        ...
        self.push.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/ux/send.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.centralwidget.setStatusTip(_translate("MainWindow", "Created by Srevin Saju. Licensed under MIT 2020"))
